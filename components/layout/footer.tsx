...
export function Footer() {
  const facebookUrl = siteConfig.socialLinks.find((link) => link.label === "Facebook")?.href || siteConfig.facebookUrl
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm text-muted-foreground">{siteConfig.workingHours}</li>
            </ul>
          </div>
        </div>
