...
const registerSchema = z.object({
  ...
  termsAccepted: z.boolean().refine((value) => value, "Vui lòng đồng ý điều khoản và chính sách bảo mật"),
      ...
      <Card className="reveal glass-card-strong w-full max-w-md rounded-2xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-start gap-2 rounded-xl border border-slate-200 bg-white/70 p-3">
              <Checkbox
                id="termsAccepted"
              ...
              <div className="space-y-1">
                <Label htmlFor="termsAccepted" className="cursor-pointer text-sm leading-6">
                  Tôi đồng ý với{" "}
...
export default function RegisterPage() {
  return (
    <Suspense
      fallback={
        <div className="page-shell page-enter premium-page-bg gradient-mesh flex min-h-screen items-center justify-center px-4 py-8">
          <Card className="glass-card-strong w-full max-w-md rounded-2xl">
            <CardContent className="flex min-h-[280px] items-center justify-center p-8 text-sm text-muted-foreground">
              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
              Đang chuẩn bị form đăng ký...
            </CardContent>
          </Card>
        </div>
      }
