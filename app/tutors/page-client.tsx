          ...
          <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
            ...
            <div className="space-y-5">
              ...
              {(masterDataLoading || masterDataError) && (
                <PublicDataNotice
                  isLoading={masterDataLoading}
                  loadingMessage="Đang tải danh mục lọc. Danh sách gia sư vẫn hiển thị bằng dữ liệu hiện có."
              ...
              {tutorsError ? (
                ...
                <Card className="glass-card-strong rounded-2xl">
                  <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <h2 className="mt-4 text-xl font-semibold">Chưa có gia sư phù hợp</h2>
                    <p className="mt-2 max-w-md text-sm text-muted-foreground">
                      Hãy thử mở rộng khu vực, giảm mức rating hoặc gửi nhu cầu học để tư vấn viên hỗ trợ matching thủ công.
                    </p>
                    <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                      ...
                      <Button asChild>
                        <a href="/register-student">Đăng ký nhu cầu học</a>
                      </Button>
                    </div>
                  </CardContent>
                </Card>
      ...
      fallback={
        <div className="premium-page-bg flex min-h-screen flex-col">
          ...
          <main className="app-container flex-1 py-10">
            <LoadingSkeleton label="Đang chuẩn bị danh sách gia sư..." />
          </main>
          <Footer />
        </div>
      }
