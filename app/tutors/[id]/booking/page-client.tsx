...
export default function BookingPage({
  ...
  const { tutor, isLoading, error, refresh } = useTutorDetail(id)
      ...
      <div className="premium-page-bg flex min-h-screen flex-col">
        ...
        <main className="app-container flex flex-1 items-center justify-center py-12">
          <div className="w-full max-w-2xl">
            <ErrorState message="Không tải được hồ sơ gia sư từ backend." onRetry={() => refresh()} />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-1 text-sm">
                      ...
                      {rating ? rating.toFixed(1) : "Mới"} ({reviewCount})
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <b>{pricePerHour ? `${formatCurrency(pricePerHour)}/giờ` : "Liên hệ"}</b>
                </div>
                <div className="flex justify-between">
                ...
                <p className="soft-panel bg-primary/10 p-3 text-primary">
                  Lịch rảnh: {formatAvailableSlots(availableSlots)}
                </p>
              </CardContent>
            </Card>
          </aside>
