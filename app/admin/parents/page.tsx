...
export default function AdminParentsPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="surface-panel border-l-4 border-l-primary p-6"><h1 className="text-2xl font-bold">Phụ huynh</h1><p className="text-sm text-muted-foreground">Danh sách tài khoản phụ huynh demo.</p></div>
